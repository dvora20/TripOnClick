...
import Button2 from "./login/ButtonPop";
...
const CalendarComponent = (props) => {
    ...
    const clickOnDeleteAndPassId = (e) => {
                                                                    ...
                                                                    <Modal open={open} onClose={() => setOpen(false)}>
                                                                        ...
                                                                        >
                                                                            ...
                                                                            <Typography id="alert-dialog-modal-description" textColor="text.tertiary">
                                                                                אתה בטוח שתרצה למחוק את האטרקציה?
                                                                            </Typography>
                                                                            <Box sx={{ display: 'flex', gap: 1, justifyContent: 'flex-end', pt: 2 }}>
                                                                                <Button variant="plain" color="neutral" onClick={() => setOpen(false)}>
                                                                                    ביטול
                                                                                </Button>
                                                                                <button className='deleteB' type="button" id={e.allAttractionDetailes.AttractionDetails._id} onClick={(e) => { handleShowDelete(e.target.id) }}  >מחק</button>
                                                                            </Box>
                                                                        </ModalDialog>
                                                                    </Modal>
                                                                </React.Fragment>
                                ...
                                <MDBModalBody className='popUpData'>
                                    <p >
                                        ...
                                        <form className='buttonAbout' >
                                            <Button2 content="לפרטים" type="submit" onClick={() => { window.open(attractionClicked.allAttractionDetailes.AttractionDetails.Url, "blank") }} />
                                        </form>
                                        <div className='description'>
